...
class AwscliV2(PythonPackage):
    ...
    version("2.33.30", sha256="2a042cbcf18469d322d3c5c0139629a991dd149281198f1a91afecee5ba11cf3")
    ...
    with default_args(type=("build", "run")):
        ...
        depends_on("py-awscrt@0.19.18:0.22.0", when="@2.22:2.24")
        depends_on("py-awscrt@0.31.2:", when="@2.33.30:")
