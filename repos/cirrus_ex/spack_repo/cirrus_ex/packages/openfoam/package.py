...
class Openfoam(Package):
    ...
    variant("cgal", default=False, description="With cgal")
    ...
    depends_on("cgal@:6", when="@2412:+cgal")
    depends_on("cgal@:5", when="@2312:2406+cgal")
    depends_on("cgal@:4", when="@:2306+cgal")
    ...
    def configure(self, spec, prefix):
        ...
        if "+cgal" in spec:
            ...
            self.etc_config["CGAL"] = {}  # Disable using CGAL
